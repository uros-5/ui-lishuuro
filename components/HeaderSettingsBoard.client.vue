...
div[data-size="8"][data-board$="1"] cg-board {
  background-image: url("/board/8x8blue.svg");
}

.board-2,
div[data-size="8"][data-board$="2"] cg-board {
  background-image: url("/board/8x8green.svg");
}

.board-3,
div[data-size="8"][data-board$="3"] cg-board {
  background-image: url("/board/8x8gray.svg");
}

.board-4,
div[data-size="8"][data-board$="4"] cg-board {
  background-image: url("/board/8x8brown_sand.svg");
}

.board-5,
div[data-size="8"][data-board$="5"] cg-board {
  background-image: url("/board/8x8brown_yellow.svg");
}
...
div[data-board$="1"][data-size$="12"] cg-board {
  background-image: url("/board/12x12blue.svg");
}

.board-2,
div[data-board$="2"][data-size$="12"] cg-board {
  background-image: url("/board/12x12green.svg");
}

.board-3,
div[data-board$="3"][data-size$="12"] cg-board {
  background-image: url("/board/12x12gray.svg");
}

.board-4,
div[data-board$="4"][data-size$="12"] cg-board {
  background-image: url("/board/12x12brown_sand.svg");
}

.board-5,
div[data-board$="5"][data-size$="12"] cg-board {
  background-image: url("/board/12x12brown_yellow.svg");
}
